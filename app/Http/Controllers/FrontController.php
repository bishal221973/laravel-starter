...
class FrontController extends Controller
{
    ...
    public function book(Request $request)
    {
        ...
        $response_text = $this->api_call("https://test.api.amadeus.com/v1/security/oauth2/token", [
            'client_id'     => settings()->get('key', $default = null),
            'client_secret' => settings()->get('secret', $default = null),
        ...
        try {
            ...
            // }
            return view('front.invoice', compact('flightDetail', 'token','payment','booking'));
        } catch (Exception $e) {
            $fullResponse = $e->getMessage();
            $jsonStart = strpos($fullResponse, '{');
            $jsonEnd = strrpos($fullResponse, '}');
